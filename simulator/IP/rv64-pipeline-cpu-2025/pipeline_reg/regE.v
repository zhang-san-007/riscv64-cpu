...
always @(posedge clk or posedge rst) begin
    if (rst || regE_bubble) begin
        ...
        //csr
        regE_o_csrid            <= decode_i_csrid;
        regE_o_csrdata          <= decode_i_csrdata;
    end
end
