...
wire [11:0] 	decode_o_csr_rid1;
wire [11:0] 	decode_o_csr_rid2;
...
decode u_decode(
	...
	.decode_o_csr_rid1        	( decode_o_csr_rid1         ),
	.decode_o_csr_rid2        	( decode_o_csr_rid2         ),
...
regE u_regE(
	...
	.regD_i_pc                	( regD_o_pc                 ),
	.decode_i_csr_rdata       	( decode_o_csr_rdata        ),
...
execute u_execute(
	...
	.regE_i_pc                  	( regE_o_pc                   ),
	.regE_i_csr_rdata           	( regE_o_csr_rdata            ),
...
regM u_regM(
	...
	.regM_o_pc              	( regM_o_pc               ),
	.regM_o_csr_rdata       	( regM_o_csr_rdata        ),
...
wire [63:0]  	regW_o_pc;
wire [63:0]  	regW_o_csr_rdata;
wire [63:0]  	regW_o_regdata2;
wire [4:0]   	regW_o_reg_rd;
wire         	regW_o_reg_wen;
wire [11:0]  	regW_o_csr_id;
wire         	regW_o_csr_wen;
...
regW u_regW(
	...
	.regM_i_pc          	( regM_o_pc           ),
	.regM_i_regdata2    	( regM_o_regdata2     ),
	.regM_i_csr_rdata   	( regM_o_csr_rdata    ),
	.regM_i_csr_id      	( regM_o_csr_id       ),
