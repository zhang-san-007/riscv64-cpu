...
decode u_decode(
	...
	.decode_o_csr_satp        	( decode_o_csr_satp         )
);
// outports wire
wire         	regE_o_allowin;
wire         	regE_o_valid;
wire [13:0]  	regE_o_opcode_info;
...
regM u_regM(
	...
	.regE_i_valid           	( regE_o_valid             ),
	.regW_i_allowin         	( regW_o_allowin           ),
...
memory u_memory(
	.clk                    	( clk                     ),
	.rst                    	( rst                     ),
	.decode_i_csr_satp      	( decode_o_csr_satp        ),
	.regM_i_pc              	( regM_o_pc                ),
